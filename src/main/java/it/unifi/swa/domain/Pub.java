...
public class Pub {
	...
	@OneToMany(targetEntity = Ordine.class, mappedBy = "local", cascade = CascadeType.ALL)
	...
	@OneToMany(targetEntity = Operator.class, mappedBy = "local", cascade = CascadeType.ALL)
	@LazyCollection(LazyCollectionOption.FALSE)
