...
//			FieldUtils.writeField(summaryController, "userAssoDao", userAssoDao, true);
//			FieldUtils.writeField(summaryController, "basketBean", basketBean, true);
